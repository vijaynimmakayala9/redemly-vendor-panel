...
const VendorRegistration = () => {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      const res = await axios.post("http://31.97.206.144:6098/api/vendor/register", data);

      setToken(res.data.token);
      alert("Vendor registered successfully! Enter the OTP sent to your email.");
      setStep(2);
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      ...
      alert("OTP Verified! Vendor is now activated.");
      navigate("/");
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-yellow-300 via-yellow-200 to-blue-300 p-6">
      ...
      <div className="w-full max-w-2xl p-6 md:p-8 rounded-3xl shadow-xl 
                      backdrop-blur-xl bg-white/60 border border-white/40">

        {/* TITLE */}
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-6
                     bg-gradient-to-r from-blue-700 to-yellow-600 bg-clip-text text-transparent">
          Vendor Registration
        </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {[
                ...
                <input
                  ...
                  className="w-full px-4 py-2 rounded-xl border border-blue-300 
              ...
              <div className="flex flex-col">
                ...
                <input type="file" name="businessLogo" onChange={handleChange} className="mt-1" />
              </div>
        ...
        {step === 2 && (
          <div className="text-center">
            ...
            <p className="text-gray-700 mb-4">Enter the OTP sent to your mobile/email.</p>
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-xl border border-blue-400 bg-white/80 
